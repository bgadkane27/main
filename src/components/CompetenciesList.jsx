...
function MenuItem({ text, video }) {
  ...
  return (
    <div className="flex-1 relative overflow-hidden text-center shadow-[0_-1px_0_0_#fff]" ref={itemRef}>
      <div
        className="flex items-center justify-center h-full relative cursor-pointer uppercase no-underline font-extrabold md:text-[10vh] hover:text-[#060010] focus:text-white focus-visible:text-[#060010]"
      ...
      <div
        className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none bg-violet-500 translate-y-[101%]"
        ref={marqueeRef}
      >
