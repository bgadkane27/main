...
const Exp = () => {
    return (
        <section id="exp" className="relative w-full container min-h-screen overflow-hidden py-20">
            ...
            <div className="relative w-full max-w-7xl mx-auto h-1/2 overflow-hidden mt-10">
                {/* <div
                    className="absolute inset-0 bg-contain bg-center no bg-no-repeat"
                    style={{ backgroundImage: "url('/imgs/08.png')" }}
                ></div> */}
                    ...
                    {experiences.map((experience, index) => (
                        ...
                        >
                            ...
                            <div className="relative z-10 p-4 h-full flex flex-col">
                                <div className="rounded-full py-1.5 mb-2 bg-[#4f96ed]">
                                    <h2 className="text-center text-lg font-semibold">{experience.title}</h2>
                                </div>
